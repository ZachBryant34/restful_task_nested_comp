...
/* harmony default export */ __webpack_exports__["default"] = ("  <h1>{{title}}</h1>\n  <br>\n  <h2>Create New Task</h2>\n  <form (submit)='onSubmit()'>\n    <label>Task Title: <input type=\"text\" name=\"newTask.title\" [(ngModel)]='newTask.title'></label>\n    <label>Task Description: <input type=\"text\" name=\"newTask.description\" [(ngModel)]='newTask.description'></label>\n    <input type=\"submit\" value=\"Create\">\n  </form>\n  <br>\n  <button (click)='onButtonClick()'>Get All Tasks:</button>\n  <br>\n  <ul>\n    <li *ngFor='let task of tasks; let index = index' (click)='onIdClick(index)'>{{task.title}}<button (click)=\"onDeleteClick(task)\">Delete</button></li>\n    <app-task *ngIf='task' [task]='task'></app-task>\n  </ul>\n  <br>\n  \n  \n\n<router-outlet></router-outlet>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div >\n    <h2>{{task.title}}</h2>\n    <h3>{{task.description}}</h3>\n    <button (click)=\"onEditClick()\">Edit</button>\n    <br>\n    <div *ngIf='editForm == true'>\n        <h3>Edit Task</h3>\n        <form (submit)='onEditSubmit()' >\n            <label>Task Title: <input type=\"text\" name='updateTask.title' [(ngModel)]='updateTask.title'></label>\n            <label>Task Description: <input type=\"text\" name='updateTask.description' [(ngModel)]='updateTask.description'></label>\n            <input type=\"submit\" value=\"Update\">\n        </form>\n    </div>\n</div>\n");
...
let AppComponent = class AppComponent {
    ...
    onEditClick() {
        this.updateTask = { _id: this.task._id, title: this.task.title, description: this.task.description };
        this.editForm = true;
    }
    onSubmit() {
    ...
    onEditSubmit() {
        this._httpService.updateTask(this.updateTask)
            .subscribe(data => {
            console.log('Got data from post back', data);
    ...
    getTaskIdFromService() {
        this._httpService.getTaskId(this.task)
            .subscribe(data => {
...
let HttpService = class HttpService {
    ...
    addTask(newtask) {
        return this._http.post('/new/tasks', newtask);
    }
    getTaskId(task) {
    ...
    deleteTask(task) {
        return this._http.delete(`/remove/${task._id}`, task);
    }
};
...
TaskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./task.component.scss */ "./src/app/task/task.component.scss")).default]
    })
], TaskComponent);
...
module.exports = __webpack_require__(/*! /Users/zacharybryant/Documents/CodingDojo/mean_stack/mean/Angular/restful_task/task/src/main.ts */"./src/main.ts");
